...
<body>
	<div style="width: 80%; margin: auto; padding: 10px; box-shadow: 0px 0px 3px rgba(0,0,0,.5);">
	
		<c:import url="/cabecalho.jsp" />
	
		<center>
			<h1>Relação de contatos</h1>
			<h3><a href="mvc?logica=AdicionaContatoLogic">Novo Contato</a></h3>
			<hr />
		     <table  class="table table-houve" style="width: 80%">
		         ...
		         <tr bgcolor="#${contador.count  % 2 == 0? 'aaee88' : 'ffffff' }">
		             ...
		             <td><a href="mvc?logica=AlteraContatoLogic&id=${contato.id}"><span class="glyphicon glyphicon-pencil"></span> Editar</a></td> 
